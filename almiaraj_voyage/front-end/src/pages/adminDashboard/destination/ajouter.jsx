...
import { Upload, Trash2, Globe, MapPin, Compass, Star, X } from "lucide-react";
...
export default function AjouterDestination() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosClient.post('/destinations', formData, {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Ajouter une destination</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="Ex: France, Maroc, Italie..."
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Ex: Paris, Marrakech, Rome..."
                  className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#fb923c]"
                />
              </div>
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              placeholder="Décrivez la destination, ses attractions, sa culture..."
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {loading ? "Ajout en cours..." : "Ajouter la destination"}
            </button>
            <Link
