            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-3 pt-4 border-t">
                        <Link to={`/admin/editHotel/${id}`} className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition flex items-center gap-2">
                        ...
                        <Link to="/admin/hotels" className="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 transition">
                            Fermer
                        </Link>
                    </div>
                </div>
